...
public class IngredientFragment extends Fragment implements IngredientView{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        allMealPresenter= new IngredientPresenterImp(this, MealsRepositoryImp.getInstance(MealsRemoteDataSourceImp.getInstance(), MealLocalDataSourceImp.getInstance()));
